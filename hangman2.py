...
'Shapes':'square triangle rectangle circle ellipse rhombus trapezoid chevron pentagon hexagon sptagon octagon'.split(),
...
def getGuess (alreadyGuessed):
    ...
    while True:
        ...
        if len(guess) != 1:
            ...
            print ('You have already guessed that letter. Chosse again.')
